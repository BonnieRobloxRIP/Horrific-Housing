...
# summon realm
execute as @r[tag=subspace1] at @s if score subspace realms matches 0 run summon brr:plate 90 0 54 0 0 from_egg subspace
execute as @e[type=brr:plate, name=subspace] at @s if score subspace realms matches 0 run structure load subspace ~-8 ~1 ~-8
# functions
execute as @r[tag=subspace] at @s run scoreboard players remove subspace1 realms 1
execute if score subspace1 realms matches ..0 run scoreboard players remove subspace realms 1
execute if score subspace1 realms matches ..0 run scoreboard players set subspace1 realms 20
# effects
execute as @a[tag=subspace] at @s if score subspace realms matches 30 if score subspace1 realms matches 1 run camerashake add @s 0.2 10 positional
execute as @e[type=brr:plate, name=subspace] at @s if score subspace realms matches 5..30 run particle brr:subspace_lobby ~ ~ ~
execute as @a[tag=subspace] at @s if score subspace realms matches 19 if score subspace1 realms matches 1 run camerashake add @s 0.5 10 positional
execute as @a[tag=subspace] at @s if score subspace realms matches 9 if score subspace1 realms matches 1 run camerashake add @s 0.8 5 positional
execute as @a[tag=subspace] at @s if score subspace realms matches 3 if score subspace1 realms matches 1 run camerashake add @s 1 2 positional
# end
# - players -
execute as @r[tag=subspace1] at @s if score subspace realms matches 1.. run scoreboard players add subspace realms 20
execute as @a[tag=subspace1] at @s if score subspace realms matches 0 run scoreboard players set subspace realms 60
...
execute as @e[type=brr:plate, name=subspace] at @s if score subspace realms matches ..0 run structure load subspaced ~-8 ~1 ~-8
execute as @e[type=brr:plate, name=subspace] at @s if score subspace realms matches ..0 run kill @s
# button
