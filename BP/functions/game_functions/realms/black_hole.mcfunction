...
# summon realm
execute as @r[tag=blackhole1] at @s if score blackhole realms matches 0 run summon brr:plate 90 0 34 0 0 from_egg blackhole
execute as @e[type=brr:plate, name=blackhole] at @s if score blackhole realms matches 0 run structure load blackhole ~-6 ~1 ~-6
# functions
execute as @r[tag=blackhole] at @s run scoreboard players remove blackhole1 realms 1
execute if score blackhole1 realms matches ..0 run scoreboard players remove blackhole realms 1
execute if score blackhole1 realms matches ..0 run scoreboard players set blackhole1 realms 20
# end
# - players -
execute as @r[tag=blackhole1] at @s if score blackhole realms matches 1.. run scoreboard players add blackhole realms 10
execute as @a[tag=blackhole1] at @s if score blackhole realms matches 0 run scoreboard players set blackhole realms 45
...
# - realm -
execute if score blackhole realms matches ..0 run kill @a[tag=blackhole]
execute as @e[type=brr:plate, name=blackhole] at @s if score blackhole realms matches ..0 run structure load blackholed ~-6 ~1 ~-6
execute as @e[type=brr:plate, name=blackhole] at @s if score blackhole realms matches ..0 run kill @s
# button
