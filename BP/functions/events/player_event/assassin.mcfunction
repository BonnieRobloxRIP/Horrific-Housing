...
execute as @a[tag=assassin1] at @s if score @a[tag=assassin, scores={assassin=1}] at @s run scoreboard players set @s assassin 2
execute as @a[tag=assassin1] at @s if score @a[tag=assassin, scores={assassin=2}] at @s run scoreboard players set @s assassin 3
execute as @a[tag=assassin1] at @s if score @a[tag=assassin, scores={assassin=3}] at @s run scoreboard players set @s assassin 4
execute as @a[tag=assassin1] at @s if score @a[tag=assassin, scores={assassin=4}] at @s run scoreboard players set @s assassin 5
execute as @a[tag=assassin1] at @s if score @a[tag=assassin, scores={assassin=5}] at @s run scoreboard players set @s assassin 6
execute as @a[tag=assassin1] at @s if score @a[tag=assassin, scores={assassin=6}] at @s run scoreboard players set @s assassin 7
execute as @a[tag=assassin1] at @s if score @a[tag=assassin, scores={assassin=7}] at @s run scoreboard players set @s assassin 8
execute as @a[tag=assassin1] at @s if score @a[tag=assassin, scores={assassin=8}] at @s run scoreboard players set @s assassin 9
execute as @a[tag=assassin1] at @s if score @a[tag=assassin, scores={assassin=9}] at @s run scoreboard players set @s assassin 10
execute as @a[tag=assassin1] at @s if score @a[tag=assassin, scores={assassin=10}] at @s run scoreboard players set @s assassin 11
execute as @a[tag=assassin1] at @s if score @a[tag=assassin, scores={assassin=11}] at @s run scoreboard players set @s assassin 12
execute as @a[tag=assassin1] at @s if score @a[tag=assassin, scores={assassin=12}] at @s run scoreboard players set @s assassin 13
execute as @a[tag=assassin1] at @s if score @a[tag=assassin, scores={assassin=13}] at @s run scoreboard players set @s assassin 14
execute as @a[tag=assassin1] at @s if score @a[tag=assassin, scores={assassin=14}] at @s run scoreboard players set @s assassin 15
execute as @a[tag=assassin1] at @s if score @a[tag=assassin, scores={assassin=15}] at @s run scoreboard players set @s assassin 16
execute as @a[tag=assassin1] at @s if score @a[tag=assassin, scores={assassin=16}] at @s run scoreboard players set @s assassin 17
execute as @a[tag=assassin1] at @s if score @a[tag=assassin, scores={assassin=17}] at @s run scoreboard players set @s assassin 18
execute as @a[tag=assassin1] at @s if score @a[tag=assassin, scores={assassin=18}] at @s run scoreboard players set @s assassin 19
execute as @a[tag=assassin1] at @s if score @a[tag=assassin, scores={assassin=19}] at @s run scoreboard players set @s assassin 20
execute as @a[tag=assassin1] at @s if score @a[tag=assassin, scores={assassin=20}] at @s run scoreboard players set @s assassin 21
...
execute as @a[tag=assassin1] at @s run scoreboard players set @s "assassin timer" 1200
