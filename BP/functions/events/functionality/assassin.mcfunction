...
execute as @a[scores={alive=0, assassin=1}, tag=game, tag=assassin] at @s run tag @a remove target1
execute as @a[scores={alive=0, assassin=2}, tag=game, tag=assassin] at @s run tag @a remove target2
execute as @a[scores={alive=0, assassin=3}, tag=game, tag=assassin] at @s run tag @a remove target3
execute as @a[scores={alive=0, assassin=4}, tag=game, tag=assassin] at @s run tag @a remove target4
execute as @a[scores={alive=0, assassin=5}, tag=game, tag=assassin] at @s run tag @a remove target5
execute as @a[scores={alive=0, assassin=6}, tag=game, tag=assassin] at @s run tag @a remove target6
execute as @a[scores={alive=0, assassin=7}, tag=game, tag=assassin] at @s run tag @a remove target7
execute as @a[scores={alive=0, assassin=8}, tag=game, tag=assassin] at @s run tag @a remove target8
execute as @a[scores={alive=0, assassin=9}, tag=game, tag=assassin] at @s run tag @a remove target9
execute as @a[scores={alive=0, assassin=10}, tag=game, tag=assassin] at @s run tag @a remove target10
execute as @a[scores={alive=0, assassin=11}, tag=game, tag=assassin] at @s run tag @a remove target11
execute as @a[scores={alive=0, assassin=12}, tag=game, tag=assassin] at @s run tag @a remove target12
execute as @a[scores={alive=0, assassin=13}, tag=game, tag=assassin] at @s run tag @a remove target13
execute as @a[scores={alive=0, assassin=14}, tag=game, tag=assassin] at @s run tag @a remove target14
execute as @a[scores={alive=0, assassin=15}, tag=game, tag=assassin] at @s run tag @a remove target15
execute as @a[scores={alive=0, assassin=16}, tag=game, tag=assassin] at @s run tag @a remove target16
execute as @a[scores={alive=0, assassin=17}, tag=game, tag=assassin] at @s run tag @a remove target17
execute as @a[scores={alive=0, assassin=18}, tag=game, tag=assassin] at @s run tag @a remove target18
execute as @a[scores={alive=0, assassin=19}, tag=game, tag=assassin] at @s run tag @a remove target19
execute as @a[scores={alive=0, assassin=20}, tag=game, tag=assassin] at @s run tag @a remove target10
execute as @a[scores={alive=0, assassin=21}, tag=game, tag=assassin] at @s run tag @a remove target21
