execute as @s[tag=shop, tag=!unequip, scores={house_color=12}] at @s run tag @s add unequip
# unequip
execute as @s[tag=shop, tag=unequip, scores={house_color=12}] at @s run scoreboard players set @s house_color 0
...
# equip
execute as @s[tag=shop, tag=!unequip] at @s run scoreboard players set @s house_color 12
execute as @s[tag=shop, tag=!unequip, scores={house_color=12}] at @s run playsound sfx.shop.equip @s 131 4 -27
execute as @s[tag=shop, tag=!unequip, scores={house_color=12}] at @s run tellraw @s {"rawtext":[{"text":"§aSuccessfully equipped color"}]}
