execute as @s[tag=shop, tag=!unequip, scores={ornament_banana=1}] at @s run tag @s add unequip
# unequip
execute as @s[tag=shop, tag=unequip, scores={ornament_banana=1}] at @s run scoreboard players set @s ornament_banana 0
execute as @s[tag=shop, tag=unequip, scores={ornament_banana=0}] at @s run playsound sfx.shop.unequip @s 131 4 -27
execute as @s[tag=shop, tag=unequip, scores={ornament_banana=0}] at @s run tellraw @s {"rawtext":[{"text":"§aSuccessfully unequipped ornament"}]}
# equip
execute as @s[tag=shop, tag=!unequip, tag=!4th_slot, scores={ornament_horns=0, equipped=..2}] at @s run scoreboard players set @s ornament_banana 1
execute as @s[tag=shop, tag=!unequip, tag=4th_slot, scores={ornament_horns=0, equipped=..3}] at @s run scoreboard players set @s ornament_banana 1
execute as @s[tag=shop, tag=!unequip, scores={ornament_banana=1}] at @s run playsound sfx.shop.equip @s 131 4 -27
execute as @s[tag=shop, tag=!unequip, scores={ornament_banana=1}] at @s run tellraw @s {"rawtext":[{"text":"§aSuccessfully equipped ornament"}]}
execute as @s[tag=shop, tag=!unequip, tag=!4th_slot, scores={ornament_horns=1, equipped=..2}] at @s run tellraw @s {"rawtext":[{"text": "§6You cannot combine §gThe Banana §6with §9The Horns!"}]}
execute as @s[tag=shop, tag=!unequip, tag=4th_slot, scores={ornament_horns=1, equipped=..3}] at @s run tellraw @s {"rawtext":[{"text": "§6You cannot combine §gThe Banana §6with §9The Horns!"}]}
...
execute as @s[tag=shop, tag=unequip, scores={ornament_banana=0}] at @s run tag @s remove unequip
# load
