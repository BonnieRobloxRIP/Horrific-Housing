execute as @s[tag=shop, tag=!unequip, scores={ornament_ring=1}] at @s run tag @s add unequip
# unequip
execute as @s[tag=shop, tag=unequip, scores={ornament_ring=1}] at @s run scoreboard players set @s ornament_ring 0
execute as @s[tag=shop, tag=unequip, scores={ornament_ring=0}] at @s run playsound sfx.shop.unequip @s 131 4 -27
execute as @s[tag=shop, tag=unequip, scores={ornament_ring=0}] at @s run tellraw @s {"rawtext":[{"text":"§aSuccessfully unequipped ornament"}]}
# equip
execute as @s[tag=shop, tag=!unequip, tag=!4th_slot, scores={equipped=..2}] at @s run scoreboard players set @s ornament_ring 1
execute as @s[tag=shop, tag=!unequip, tag=4th_slot, scores={equipped=..3}] at @s run scoreboard players set @s ornament_ring 1
execute as @s[tag=shop, tag=!unequip, scores={ornament_ring=1}] at @s run playsound sfx.shop.equip @s 131 4 -27
execute as @s[tag=shop, tag=!unequip, scores={ornament_ring=1}] at @s run tellraw @s {"rawtext":[{"text":"§aSuccessfully equipped ornament"}]}
...
execute as @s[tag=shop, tag=unequip, scores={ornament_ring=0}] at @s run tag @s remove unequip
# load
